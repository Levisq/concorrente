...
public class Deconvolution {
    ...
    public static float[][] redRestored;
    public static float[][] greenRestored;
    public static float[][] blueRestored;
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread redThread = new Thread(new CorThread(red, psf, psfFlipped, iterations), "red");
        Thread blueThread = new Thread(new CorThread(blue, psf, psfFlipped, iterations), "blue");
        Thread greenThread = new Thread(new CorThread(green, psf, psfFlipped, iterations), "green");
    ...
    static class CorThread implements Runnable  {
        float[][] cor;
        float[][] psf;
        float[][] psfFlipped;
        int iterations;

        public CorThread (float[][] cor, float[][] psf, float[][] psfFlipped, int iterations){
            this.cor = cor;
            this.psf = psf;
        ...
        @Override
        public void run() {
            float[][] restored = richardsonLucy(cor, psf, psfFlipped, iterations);
            String name = Thread.currentThread().getName();
            
            if(name.equals("red")){
                Deconvolution.redRestored = restored;
            }
            else if(name.equals("green")){
                Deconvolution.greenRestored = restored;
            }
            else if(name.equals("blue")){
                Deconvolution.blueRestored = restored;
            }
        }
